...
- 825be83: Complete the block-tools structurer migration: move the block facade to the
...
- Updated dependencies [d2b5924]
  - @platforma-open/milaboratories.immune-assay-data.ui@1.9.2
  - @platforma-open/milaboratories.immune-assay-data.model@1.10.2
  - @platforma-open/milaboratories.immune-assay-data.workflow@1.14.2
...
- Updated dependencies [2036371]
  ...
  - @platforma-open/milaboratories.immune-assay-data.ui@1.9.1
  - @platforma-open/milaboratories.immune-assay-data.workflow@1.14.1
...
- Updated dependencies [2816b0f]
  - @platforma-open/milaboratories.immune-assay-data.workflow@1.13.1
