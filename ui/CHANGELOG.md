...
- Updated dependencies [1465cbb]
  - @platforma-open/milaboratories.immune-assay-data.kind@1.1.2
  - @platforma-open/milaboratories.immune-assay-data.model@1.12.3

## 1.10.2

### Patch Changes

- Updated dependencies [d352b0b]
  - @platforma-open/milaboratories.immune-assay-data.kind@1.1.1
  - @platforma-open/milaboratories.immune-assay-data.model@1.12.2
...
- Updated dependencies [3ced003]
  - @platforma-open/milaboratories.immune-assay-data.model@1.12.0
  - @platforma-open/milaboratories.immune-assay-data.kind@1.1.0

## 1.9.7

### Patch Changes

- cc21221: Handle empty columns in imported assay files: fully empty headerless columns are skipped, and a headerless column that contains data now produces a clear import error instead of crashing the workflow prerun with "invalid index type: undefined". The header-uniqueness check now applies to named columns only.

## 1.9.6

### Patch Changes

- Updated dependencies [1496183]
  - @platforma-open/milaboratories.immune-assay-data.model@1.11.0
...
- Updated dependencies [52688ec]
  - @platforma-open/milaboratories.immune-assay-data.model@1.10.5
...
- Updated dependencies [ec0c7d6]
  - @platforma-open/milaboratories.immune-assay-data.model@1.10.4
